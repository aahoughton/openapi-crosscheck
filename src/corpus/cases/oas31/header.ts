 ...
 * Header parameters.
 *
 * `simple` is the default style, and the location brings its own rules: header
 * names are case insensitive, and a name can appear more than once on a request
 * in a way no other location allows.
 */
export const headerCases: readonly Case[] = [
  ...
  {
    id: "header-simple-array-case-variant-oas31",
  ...
  {
    id: "header-simple-array-duplicate-name-oas31",
  ...
  {
    id: "header-simple-object-canonical-oas31",
