...
export const queryCases: readonly Case[] = [
  ...
  },
  {
    ...
    rationale:
      ...
      "libraries part. Until this case, every declaration in the corpus was required, " +
      "which was a constant the corpus was holding fixed.",
    document: document(
  ...
  },
  {
    ...
    rationale:
      ...
      "settled by required being false. The value channel is where this case lives: in " +
      "3.1 the Schema Object is a superset of JSON Schema 2020-12, where default is an " +
      "annotation, and annotations do not modify the instance, so a validator that " +
      "injects blue supplies a value the specification does not ask for. Libraries " +
      "differ, the values answer, and none are expected.",
    document: document(
      [
        {
          name: "p",
