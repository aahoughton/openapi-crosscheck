...
export const queryCases30: readonly Case[] = [
  ...
  },
  {
    ...
    oasVersion: "3.0",
    question:
      "OpenAPI 3.0 requires type to be a string and forbids arrays of types. It does not prescribe how validators handle this invalid document. The request value otherwise satisfies the string type.",
