...
| [`header-simple-object-explode-oas30`](#header-simple-object-explode-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | pass | n/a | pass |
...
| [`path-label-array-foreign-shape-oas30`](#path-label-array-foreign-shape-oas30) | rejected | FAIL (verdict) | pass | pass | FAIL (verdict) | pass | FAIL (verdict) | pass | pass | n/a | FAIL (verdict) |
| [`path-label-object-canonical-oas30`](#path-label-object-canonical-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | FAIL (verdict) | n/a | FAIL (verdict) |
| [`path-label-object-explode-oas30`](#path-label-object-explode-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | FAIL (verdict) | n/a | FAIL (value) |
...
| [`path-matrix-array-foreign-shape-oas30`](#path-matrix-array-foreign-shape-oas30) | rejected | FAIL (verdict) | FAIL (verdict) | pass | FAIL (verdict) | pass | FAIL (verdict) | pass | pass | n/a | FAIL (verdict) |
...
| [`path-matrix-object-canonical-oas30`](#path-matrix-object-canonical-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | FAIL (verdict) | n/a | pass |
| [`path-matrix-object-explode-oas30`](#path-matrix-object-explode-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | FAIL (verdict) | n/a | FAIL (value) |
...
| [`path-simple-object-explode-oas30`](#path-simple-object-explode-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | pass | n/a | pass |
...
| [`query-pipe-delimited-object-canonical-oas30`](#query-pipe-delimited-object-canonical-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | FAIL (value) | n/a | pass |
...
| [`query-space-delimited-object-canonical-oas30`](#query-space-delimited-object-canonical-oas30) | accepted | FAIL (verdict) | FAIL (verdict) | FAIL (verdict) | pass (verdict only) | FAIL (verdict) | FAIL (value) | FAIL (verdict) | pass | n/a | pass |
